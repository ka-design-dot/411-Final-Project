...
from weather_app.utils.logger import configure_logger #IDK WHY IT GIVES THIS ERROR
...
DB_PATH = os.getenv("DB_PATH", "/app/sql/weather_list.db") #THIS NEEDS TO BE CHANGED
